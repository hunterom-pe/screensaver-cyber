...
//  CyberpunkSaver
//
//  Native macOS ScreenSaverView subclass featuring Option 1 Frosted Glass Telemetry Badges
//  with 12-Hour Clock, Phoenix Open-Meteo Weather, System Gauges, and Zero Clutter.
//
...
public class CyberpunkSaverView: ScreenSaverView {
    ...
    public override func draw(_ rect: NSRect) {
        ...
        // 2. Draw Option 1 High-Contrast Glass Telemetry Badges
